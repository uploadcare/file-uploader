...
export function checkerboardCssBg(color1 = '#fff', color2 = 'rgba(0, 0, 0, .1)'): string {
...
export function strokesCssBg(color = 'rgba(0, 0, 0, .1)'): string {
...
export function fileCssBg(color = 'hsl(209, 21%, 65%)', width = 32, height = 32): string {
