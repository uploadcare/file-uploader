export default {
  ...
  flip: 'Перевернути',
  mirror: 'Дзеркало',
  'a11y-cloud-editor-apply-filter': 'Застосувати фільтр {{filterName}}',
  'a11y-cloud-editor-apply-crop': 'Застосувати операцію {{filterName}}',
  'a11y-cloud-editor-apply-tuning': 'Застосувати налаштування {{filterName}}',
};
