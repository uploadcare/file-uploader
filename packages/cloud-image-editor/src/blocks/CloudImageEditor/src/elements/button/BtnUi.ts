import { LitBlock } from '@uploadcare/file-uploader/internal';
...
import '@uploadcare/file-uploader/internal';
import type { AriaRole } from '@uploadcare/file-uploader/internal';
